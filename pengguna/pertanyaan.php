...
.menu-atas{
  ...
  padding:0 16px;box-shadow:0 2px 8px rgba(0,0,0,.25);z-index:100;
}
...
.pembungkus{padding-top:70px;min-height:100vh;}
.instruksi{
  width:min(1060px, calc(100% - 40px));
  margin:18px auto 14px;
  padding:10px 16px;
  font-size:15px;line-height:1.5;font-weight:600;color:#111;text-align:center;
}

.bagi-dua{position:relative;width:100%;min-height:calc(100vh - 70px - 70px);display:flex;}
...
.isi-pertanyaan{overflow:auto;max-height:440px;padding-right:4px;}
.judul-pertanyaan{font-weight:800;font-size:16px;margin-bottom:10px;}

.pilihan-radio{display:flex;gap:14px;flex-wrap:wrap;align-items:center;font-size:13px;margin-bottom:10px;}
.pilihan-radio label{display:inline-flex;gap:6px;align-items:center;cursor:pointer;user-select:none;}
.pilihan-radio input{transform: translateY(1px);}

.baris-bawah{display:flex;justify-content:flex-end;align-items:flex-end;margin-top:10px;}
.pembungkus-navigasi{display:flex;flex-direction:column;align-items:flex-end;gap:8px;}
.progres{font-size:12px;font-weight:800;color:#111;display:flex;gap:6px;align-items:center;}
.baris-tombol{display:flex;gap:10px;align-items:center;}

.tombol{
  border:2px solid #777;background:#fff;padding:6px 12px;border-radius:8px;
  cursor:pointer;font-weight:700;font-size:12px;box-shadow:0 2px 0 rgba(0,0,0,.25);
}
.tombol:disabled{opacity:.5;cursor:not-allowed;}

.pembungkus-keluar{display:flex;justify-content:center;margin-top:8px;}
.tombol-keluar{
  border:2px solid #7a1d1d;background:#e85b5b;color:#fff;padding:6px 18px;border-radius:8px;
  cursor:pointer;font-weight:800;font-size:12px;box-shadow:0 2px 0 rgba(0,0,0,.25);
      ...
      <div class="bagi-dua">
        ...
        <div class="latar-kanan">
          <div class="panel-keyakinan">
            ...
            <div class="list-keyakinan">
              <div class="key-item">
                <div class="key-head">
                  <div class="badge-cf cf-0"></div>
                  <div class="key-title">Tidak yakin / Tidak mengalami gejala</div>
                </div>
                <p class="key-desc">Pengguna merasa tidak mengalami gejala sama sekali.</p>
              </div>

              <div class="key-item">
                <div class="key-head">
                  <div class="badge-cf cf-2"></div>
                  <div class="key-title">Agak yakin</div>
                </div>
                <p class="key-desc">Pengguna merasa gejala sedikit muncul, tetapi masih ragu atau tidak sering terjadi.</p>
              </div>

              <div class="key-item">
                <div class="key-head">
                  <div class="badge-cf cf-4"></div>
                  <div class="key-title">Cukup yakin</div>
                </div>
                <p class="key-desc">Pengguna merasa gejala cukup sering muncul, namun belum terlalu mengganggu.</p>
              </div>

              <div class="key-item">
                <div class="key-head">
                  <div class="badge-cf cf-8"></div>
                  <div class="key-title">Yakin</div>
                </div>
                <p class="key-desc">Pengguna yakin benar mengalami gejala secara nyata dan cukup sering.</p>
              </div>

              <div class="key-item">
                <div class="key-head">
                  <div class="badge-cf cf-10"></div>
                  <div class="key-title">Sangat yakin / Pasti mengalami gejala</div>
                </div>
                <p class="key-desc">Pengguna sangat yakin mengalami gejala tersebut.</p>
              </div>
            </div>
