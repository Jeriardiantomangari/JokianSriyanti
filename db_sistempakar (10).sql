...
--
-- Host: localhost:3306
-- Waktu pembuatan: 04 Feb 2026 pada 11.29
-- Versi server: 8.4.3
-- Versi PHP: 8.3.26
...
(161, 46, 17, 0.492955, 49.30, 'Sedang'),
(162, 46, 11, 0.353833, 35.38, 'Ringan'),
(163, 46, 16, 0.220326, 22.03, 'Ringan'),
(164, 46, 15, 0.208000, 20.80, 'Ringan'),
(165, 46, 12, 0.187840, 18.78, 'Ringan'),
(166, 46, 14, 0.187088, 18.71, 'Ringan'),
(167, 46, 13, 0.152128, 15.21, 'Ringan');
...
(46, 'P0002', '2026-02-04 19:48:49', 17, 0.492955, 49.30, 'Sedang');
...
INSERT INTO `pengguna` (`id_pengguna`, `nama_pengguna`, `jenis_kelamin`, `usia`, `alamat`, `tanggal_daftar`) VALUES
('P0001', 'Kaneji', 'Laki-laki', 200, 'jayapura', '2026-02-03'),
('P0002', 'sri', 'Perempuan', 22, 'sentani', '2026-02-04');
...
--
ALTER TABLE `cf_gangguan`
  MODIFY `id_cf_gangguan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;

--
-- AUTO_INCREMENT untuk tabel `detail_konsultasi`
--
ALTER TABLE `detail_konsultasi`
  MODIFY `id_detail` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1414;
...
--
ALTER TABLE `konsultasi`
  MODIFY `id_konsultasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
